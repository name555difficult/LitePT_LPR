...
from .wild_places import WildPlacesDataset
...
class WildPlacesBatchSampler(Sampler):
    ...
    def __init__(self, dataset: WildPlacesDataset, batch_size: int, batch_size_limit: int = None,
        ...
        self.elems_ndx = list(self.dataset.data_list)    # List of point cloud indexes
        self.batch_idx = []     # Index of elements in each batch (re-generated every epoch)
        self.generate_batches() # initialize the batch_idx
